<<<<<<<< HEAD:GirlsFrontline-Connexion/Assets/Scripts/Core/Utility/Manager/ObjectManager.cs
﻿using GloryDay.Debug;
using GloryDay.Utility;
using UnityEngine;
using Core.Utility.Manager.Object;

namespace Core.Utility.Manager
========
﻿using Backend.Utility.Management.Object;
using GloryDay;
using GloryDay.Debug.Log;
using UnityEngine;

namespace Backend.Utility.Management
>>>>>>>> develop:GirlsFrontline-Connexion/Assets/Scripts/Core/Utility/Management/ObjectManager.cs
{
