...
<<<<<<<< HEAD:GirlsFrontline-Connexion/Assets/Scripts/Core/Utility/Manager/Object/ObjectPool.cs
using Console = GloryDay.Debug.Console;

namespace Core.Utility.Manager.Object
========
namespace Backend.Utility.Management.Object
>>>>>>>> develop:GirlsFrontline-Connexion/Assets/Scripts/Core/Utility/Management/Object/ObjectPool.cs
{
    ...
    public class ObjectPool
    {
        ...
        public void Create(GameObject original, Transform parent, int capacity)
        {
            ...
            {
                Console.LogError($"Pool for object type {original.name} has already been created");
            }
        ...
        public void Release(GameObject clone)
        {
            ...
            Console.LogError($"No pool contains the object {clone.name}");
        }
