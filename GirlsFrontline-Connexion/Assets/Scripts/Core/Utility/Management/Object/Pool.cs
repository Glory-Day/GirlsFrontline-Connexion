...
<<<<<<<< HEAD:GirlsFrontline-Connexion/Assets/Scripts/Core/Utility/Manager/Object/Pool.cs
namespace Core.Utility.Manager.Object
========
namespace Backend.Utility.Management.Object
>>>>>>>> develop:GirlsFrontline-Connexion/Assets/Scripts/Core/Utility/Management/Object/Pool.cs
{
    public class Pool<T>
    {
        /// <summary>
        ...
        public void Release(T key)
        {
            ...
            Console.LogError($"This object pool does not contain the object provided: {key}");
        }
