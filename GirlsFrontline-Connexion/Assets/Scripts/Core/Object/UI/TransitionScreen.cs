...
using GloryDay.UI;
using UnityEngine;
<<<<<<<< HEAD:GirlsFrontline-Connexion/Assets/Scripts/Core/UI/TransitionScreen.cs
...
>>>>>>>> develop:GirlsFrontline-Connexion/Assets/Scripts/Core/Object/UI/TransitionScreen.cs
{
